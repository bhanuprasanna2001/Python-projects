...
def create_parser() -> argparse.ArgumentParser:
    ...
    create_parser.add_argument("--due", type=parse_datetime, help="Due date (YYYY-MM-DD HH:MM)")
    ...
    list_parser.add_argument(
        "-s",
        "--sort-by",
        choices=["priority", "due_date", "created_at"],
    ...
    search_group.add_argument(
        "--date-field",
        choices=["due_date", "created_at"],
        help="Search by date range (requires --from and --to)",
    )
    search_parser.add_argument(
        "--from", dest="from_date", type=parse_datetime, help="Start date for range search"
    )
    search_parser.add_argument(
        "--to", dest="to_date", type=parse_datetime, help="End date for range search"
    )
